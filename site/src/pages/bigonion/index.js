...
import bigo from '../bigonion/img/onion.png'
      ...
      <div className='maezona'>
        <div className='color'>
          ...
          <div className='promo12'>
            <img className='bigo' src={bigo} alt='Hamburguer' />
            <div className='textos'>
              ...
              <h1><span>Total:</span> <span id="precoTotal">{(quantidade * 34.90).toFixed(2)}</span></h1>
            </div>
          </div>
